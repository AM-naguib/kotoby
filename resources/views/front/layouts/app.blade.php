...
<head>
    ...
    <link rel="canonical" href="https://kotoby.ink/" />

    <meta name="description" content="@yield('description')">
    <meta name="keywords" content="@yield('keywords')">
    <!-- OpenGraph Meta Tags -->
<meta property="og:title" content="@yield('title') - {{ getSetting()->site_title }}">
<meta property="og:description" content="@yield('description')">
<meta property="og:url" content="{{env('APP_URL')}}">
<meta property="og:image" content="{{env('APP_URL')}}/storage/{{getSetting()->site_favicon}}">
<meta property="og:type" content="website">

    @yield('meta')
    <link rel="icon" type="image/x-icon" href="{{env('APP_URL')}}/storage/{{getSetting()->site_favicon}}">
                    ...
                    <div class="left">
                        <a class="navbar-brand" href="{{ route('front.index') }}">
                            @if (getSetting()->site_logo)
                                <img src="{{ env('APP_URL') . '/storage/' . getSetting()->site_logo }}" alt="Logo">
                            @else
                    ...
                    <div class="login-menu">
                        @guest
                            <a href="{{ route('login.create') }}"
                                class="btn btn-danger text-white rounded-pill d-none d-md-inline-block">تسجيل الدخول</a>
                            <a href="{{ route('register.create') }}"
                                class="btn btn-primary text-white rounded-pill d-none d-md-inline-block">انشاء حساب</a>
