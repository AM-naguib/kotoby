...
@section('meta')
    <meta name="url" content="{{ route('front.index') }}">
    <meta name="image" content="https://www.4readlib.com/images/logo.png">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="author-label">
                                    @if ($book->author && $book->author->slug)
                                        <a
                                            href="{{ route('front.page', ['type' => 'author', 'slug' => $book->author->slug]) }}">
                                            {{ $book->author->name }}
                                        </a>
                                    @endif
                                    @if (!$book->isFavorite())
