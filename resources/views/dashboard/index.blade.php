                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                                ...
                                                src="{{ asset('dashboard/assets') }}/img/team/profile-picture-1.jpg"></a></div>
                            ...
                            <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                                alt="Image placeholder"
                                                src="{{ asset('dashboard/assets') }}/img/team/profile-picture-3.jpg"></a></div>
                                    <div class="col-auto px-0">
                            ...
                            <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                                alt="Image placeholder"
                                                src="{{ asset('dashboard/assets') }}/img/team/profile-picture-2.jpg"></a></div>
                                    <div class="col-auto px-0">
                                        <h4 class="fs-6 text-dark mb-0"><a href="#">Chris Wood</a></h4><span
                            ...
                            <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                                alt="Image placeholder"
                                                src="{{ asset('dashboard/assets') }}/img/team/profile-picture-4.jpg"></a></div>
                                    <div class="col-auto px-0">
                            ...
                            <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                                alt="Image placeholder"
                                                src="{{ asset('dashboard/assets') }}/img/team/profile-picture-5.jpg"></a></div>
                                    <div class="col-auto px-0">
                            ...
                            <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                                alt="Image placeholder"
                                                src="{{ asset('dashboard/assets') }}/img/team/profile-picture-6.jpg"></a></div>
                                    <div class="col-auto px-0">
                            ...
                            <li class="list-group-item bg-transparent py-3 px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"> <a href="#" class="avatar-md"><img class="rounded"
                                                alt="Image placeholder"
                                                src="{{ asset('dashboard/assets') }}/img/team/profile-picture-7.jpg"></a></div>
                                    <div class="col-auto px-0">
                                ...
                                <ul class="list-group list-group-flush list my--3">
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="#" class="avatar"><img class="rounded"
                                                        alt="Image placeholder"
                                                        src="{{ asset('dashboard/assets') }}/img/team/profile-picture-1.jpg"></a>
                                            </div>
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="../users.html" class="avatar"><img
                                                        ...
                                                        src="{{ asset('dashboard/assets') }}/img/team/profile-picture-2.jpg"></a>
                                            </div>
                                            <div class="col-auto ms--2">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="#" class="avatar"><img
                                                        class="rounded-circle" alt="Image placeholder"
                                                        src="{{ asset('dashboard/assets') }}/img/team/profile-picture-3.jpg"></a>
                                            </div>
                                            <div class="col-auto ms--2">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="#" class="avatar"><img
                                                        class="rounded-circle" alt="Image placeholder"
                                                        src="{{ asset('dashboard/assets') }}/img/team/profile-picture-4.jpg"></a>
                                            </div>
                                            <div class="col-auto ms--2">
